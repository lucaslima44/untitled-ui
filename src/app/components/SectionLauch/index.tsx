    ...
    <section className="py-16 xl:py-24">
      <GridContainer>
        <div className="w-full max-w-2xl mb-16">
          ...
          <h2 className="text-3xl/relaxed xl:text-4xl font-semibold text-gray-900 -tracking-[0.72px] mb-5">
          ...
          <p className="text-lg/relaxed xl:text-xl/6 text-gray-600">
            ...
            data you need to launch and grow your bussines faster.
          </p>
        </div>
        ...
        <div className="flex flex-col xl:flex-row gap-12 xl:gap-0 items-center justify-between">
          ...
          <div>
            <Image
              ...
              height={560}
              alt="Image Lauch"
              className="max-h-80 xl:max-h-[560px]"
            />
          </div>
        </div>
      </GridContainer>
