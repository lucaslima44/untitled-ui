import { ChartNoAxesColumn, Command, Mail, MessageCircle, Smile, Zap } from "lucide-react";
        ...
        <section className="py-16 xl:py-24">
            <GridContainer>
                <div className="text-center mb-16">
                    <small className="block text-sm xl:text-base text-brand-700 font-semibold mb-3">Features</small>
                    <h2 className="text-center text-3xl xl:text-4xl text-gray-900 tracking-[-0.72px] font-semibold mb-5">Analytics that feels like it’s from the future</h2>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-x-8 gap-y-12 xl:gap-y-16">
                    <ItemFeature
                    icon={<Mail size={24} className="text-brand-600" />}
                    ...
                    />
                    <ItemFeature
                    icon={<ChartNoAxesColumn size={24} className="text-brand-600" />}
                    ...
                    />
                    <ItemFeature
                    icon={<Smile size={24} className="text-brand-600" />}
                    ...
                    />
                    <ItemFeature
                    icon={<Command size={24} className="text-brand-600" />}
