    ...
    <section className="pt-16 xl:pt-24">
      <GridContainer>
        <div className="text-center mb-16">
          <span className="inline- py-1 px-3 bg-brand-50 rounded-2xl text-sm/snug font-medium text-brand-700">
            Features
          </span>
        ...
        <div className="flex flex-col xl:flex-row gap-10 xl:gap-0items-start justify-between">
          <ItemFeature
